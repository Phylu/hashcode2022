...
type FirstContributorWithSkillsSortedByScore struct{}

func (s FirstContributorWithSkillsSortedByScore) Run(dataset models.InputDataset) models.OutputDataset {
