...
type FirstContributorWithSkillsSortedByBestBefore struct{}

func (s FirstContributorWithSkillsSortedByBestBefore) Run(dataset models.InputDataset) models.OutputDataset {
